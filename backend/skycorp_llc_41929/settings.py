"""
Django settings for skycorp_llc_41929 project.
...
ROOT_URLCONF = 'skycorp_llc_41929.urls'
...
WSGI_APPLICATION = 'skycorp_llc_41929.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skycorp_llc_41929 API",
    "DESCRIPTION": "API documentation for skycorp_llc_41929 App",
    "VERSION": "v1",
}
